...
import os
os.chdir(r"C:\Users\jonull\Box\python")  # not needed unless running line-by-line in a console
...
pickleJar = ""
data = pickle.load(open(r"C:\Users\jonull\Box\python\PickleJar\data_results_6h.pickle", "rb"))
