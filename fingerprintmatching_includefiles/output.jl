function print_results(optresults, combos, params)
    (; start_time, ref_folder, maxtime, years, years_to_optimize, years_per_set, sum_func, BBO_algs) = params
    ...
    timestamp = Dates.format(start_time, "u_dd_HH.MM.SS")
    folder_name = "results\\$ref_folder/FP $sum_func $timestamp $(years_per_set)yr"
    mkpath(folder_name)
